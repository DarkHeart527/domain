...
function movePic() {
 ...
 setTimeout( function() { document.getElementById('test').style = "background-color: red;background: url('https://darkheart527.github.io/domain-storage/Heart.png') repeat fixed";
